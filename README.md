...
O Projeto Arcade consiste na criação de um Arcade, o qual possui inicialmente quatro escolhas, três dessas escolhas contém jogos diferentes e a última opção é a saída do jogo. Os jogos feitos são: Cobra na Caixa, Show do milhão e Gousmar War. A partir disso, .
